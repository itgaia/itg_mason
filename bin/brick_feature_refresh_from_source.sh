...
LOOK_FOR="$LOOK_FOR_1\n.*$LOOK_FOR_2"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_model_fields.txt`/g" \
...
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_bloc_fields.txt`/s" \
  $TGTFF/presentation/add_edit/bloc/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_item_add_edit_bloc.dart
...
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_bloc_test_fields.txt`/s" \
...
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_event_fields.txt`/s" \
  $TGTFF/presentation/add_edit/bloc/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_item_add_edit_event.dart

LOOK_FOR_START='    \/\/\*\* fields start \*\*\/\/'
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_event_test_fields.txt`/s" \
...
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_view_fields.txt`/s" \
  $TGTFF/presentation/add_edit/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_item_add_edit_view.dart
...
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_add_edit_view_test_fields.txt`/s" \
  $TGTTFF/presentation/add_edit/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_item_add_edit_view_test.dart
...
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_list_item_fields.txt`/s" \
  $TGTFF/presentation/main/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_list_item.dart

LOOK_FOR_START='            \/\/\*\* fields start \*\*\/\/'
LOOK_FOR_END='\/\/\*\* fields end \*\*\/\/'
LOOK_FOR="$LOOK_FOR_START(.*)$LOOK_FOR_END"
perl -i -p0e "s/$LOOK_FOR/`cat bin\/template_item_screen_fields.txt`/s" \
