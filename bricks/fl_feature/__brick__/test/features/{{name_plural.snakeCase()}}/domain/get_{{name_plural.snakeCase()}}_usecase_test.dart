...
void main() {
  ...
  final t{{#pascalCase}}{{name_plural}}{{/pascalCase}} = {{#camelCase}}{{name_plural}}{{/camelCase}}TestData();
  ...
  group('Get{{#pascalCase}}{{name_plural}}{{/pascalCase}}Usecase', () {
    ...
    group('GCCUC get', () {
      ...
      test('GCCUC should get {{#camelCase}}{{name_plural}}{{/camelCase}} from the repository', () async {
        when(() => mockRepository.get{{#pascalCase}}{{name_plural}}{{/pascalCase}}())
            .thenAnswer((_) async => Right(t{{#pascalCase}}{{name_plural}}{{/pascalCase}}));
        final subject = createSubject();
