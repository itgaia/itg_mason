...
import 'package:{{#snakeCase}}{{app_name}}{{/snakeCase}}/src/features/{{#snakeCase}}{{name_plural}}{{/snakeCase}}/presentation/show/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_item_screen.dart';
...
void main() {
  setUp(() async {
    ...
    sl<SettingsService>().appMainPage = {{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemScreen(data: {{#camelCase}}{{name_plural}}{{/camelCase}}TestData().first);
  });
  ...
  group('{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemScreen', () {
    ...
    testWidgets('{{#upperCase}}{{abbreviation}}{{/upperCase}}IS render {{#pascalCase}}{{name_singular}}{{/pascalCase}} fields', (WidgetTester widgetTester) async {
      // List<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model> data = {{#camelCase}}{{name_plural}}{{/camelCase}}TestData();
