...
void main() {
  ...
  setUpAll(() {
    ...
    {{#camelCase}}{{name_plural}}{{/camelCase}}RegisterFallbackValue();
  });

  setUp(() {
    mockGet{{#pascalCase}}{{name_plural}}{{/pascalCase}}Usecase = MockGet{{#pascalCase}}{{name_plural}}{{/pascalCase}}Usecase();
    // bloc = {{#pascalCase}}{{name_plural}}{{/pascalCase}}Bloc({{#camelCase}}{{name_plural}}{{/camelCase}}: mockGet{{#pascalCase}}{{name_plural}}{{/pascalCase}}Usecase);
