...
void main() {
  final {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {{#camelCase}}{{name_plural}}{{/camelCase}}Item = {{#camelCase}}{{name_plural}}{{/camelCase}}TestData().first;
  ...
  setUp(() async {
    ...
    when(() => mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditBloc.state).thenReturn(
      sample{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditState(initialData: {{#camelCase}}{{name_plural}}{{/camelCase}}Item)
    );
  ...
  group('{{#pascalCase}}{{name_plural}}{{/pascalCase}} Item Add/Edit view tests', () {
    ...
    testWidgets('{{#upperCase}}{{abbreviation}}{{/upperCase}}IAEV show view widgets', (widgetTester) async {
      ...
      expect(find.byType(TextFormField), findsNWidgets({{fields_length}}));
