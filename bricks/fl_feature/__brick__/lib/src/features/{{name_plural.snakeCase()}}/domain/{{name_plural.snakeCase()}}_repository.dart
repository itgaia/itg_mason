...
abstract class {{#pascalCase}}{{name_plural}}{{/pascalCase}}Repository {
  ...
  Future<Either<Failure, {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model>> save{{#pascalCase}}{{name_plural}}{{/pascalCase}}Item({{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {{#camelCase}}{{name_plural}}{{/camelCase}}Item);
