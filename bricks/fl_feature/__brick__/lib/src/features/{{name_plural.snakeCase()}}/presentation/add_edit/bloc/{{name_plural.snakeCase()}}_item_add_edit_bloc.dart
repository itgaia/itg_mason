...
class {{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditBloc extends Bloc<{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditEvent, {{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditState> {
  ...
  Future<void> _onSubmitted(
    ...
    final {{#camelCase}}{{name_plural}}{{/camelCase}}Item = (state.initialData ?? const {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model({{#fields}}{{#required}}{{#camelCase}}{{field_name}}{{/camelCase}}: {{empty_value}}{{^is_last_required}}, {{/is_last_required}}{{/required}}{{/fields}})).copyWith(
    ...
    final failureOrSuccess = await _save{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemUsecase({{#camelCase}}{{name_plural}}{{/camelCase}}Item);
    ...
    emit(
      failureOrSuccess.fold(
        ...
        ({{#camelCase}}{{name_plural}}{{/camelCase}}Item) => state.copyWith(status: {{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditStatus.success)
      )
    );
  }
}