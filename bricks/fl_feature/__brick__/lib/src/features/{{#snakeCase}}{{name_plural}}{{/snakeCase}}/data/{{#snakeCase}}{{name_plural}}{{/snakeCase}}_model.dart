...
class {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model with _${{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {
  ...
  const factory {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model({
    ...
    //** fields start **//
    {{#fields}}{{#required}}@JsonKey(toJson: omitEmpty) required String {{#camelCase}}{{field_name}}{{/camelCase}},{{/required}}
    {{^required}}@Default('') @JsonKey(toJson: omitEmpty, includeIfNull: false) String {{#camelCase}}{{field_name}}{{/camelCase}},{{/required}}{{^is_last}}
  ...
  String get title => [{{#fields}}{{#is_title}}{{#camelCase}}{{field_name}}{{/camelCase}},{{/is_title}}{{/fields}}].join(',');
