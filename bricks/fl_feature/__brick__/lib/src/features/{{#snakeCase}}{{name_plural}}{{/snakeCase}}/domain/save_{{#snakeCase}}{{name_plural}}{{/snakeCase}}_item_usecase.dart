...
class Save{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemUsecase implements UseCase<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model, {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model> {
  ...
  @override
  Future<Either<Failure, {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model>> call({{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {{#snakeCase}}{{name_singular}}{{/snakeCase}}) async {
    itgLogVerbose('Save{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemUsecase - call...');
    return repository.save{{#pascalCase}}{{name_plural}}{{/pascalCase}}Item({{#snakeCase}}{{name_singular}}{{/snakeCase}});
  }
}
