...
void main() {
  final {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model tItem = {{#snakeCase}}{{name_plural}}{{/snakeCase}}TestData().first;
  ...
  group('{{#upperCase}}{{abbreviation}}{{/upperCase}}IAEP - edit item', () {
    ...
    testWidgets('{{#upperCase}}{{abbreviation}}{{/upperCase}}IAEP edit fields', (widgetTester) async {
      // when(() => mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditBloc.add({{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditDescriptionChangedEvent(tItem.description)))
      //   .thenReturn({});
      ...
      // await widgetTester.enterText(find.byKey(const Key('$key{{#pascalCase}}{{name_plural}}{{/pascalCase}}WidgetItemAddEditBase-col1-description')), tItem.description);
      // await widgetTester.pumpAndSettle();
      //
      // verify(() => mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditBloc.add({{#pascalCase}}{{name_plural}}{{/pascalCase}}ItemAddEditDescriptionChangedEvent(tItem.description))).called(1);
    }, skip: true);
  });
}