...
import 'package:dev_framework_tutorial/src/features/{{#snakeCase}}{{name_plural}}{{/snakeCase}}/presentation/main/{{#snakeCase}}{{name_plural}}{{/snakeCase}}_list_item.dart';
...
void main() {
  ...
  group('{{#pascalCase}}{{name_plural}}{{/pascalCase}}List', () {
    ...
    testWidgets('renders (show) N items', (widgetTester) async {
      ...
      //     .thenReturn(Loaded({{#snakeCase}}{{name_plural}}{{/snakeCase}}: mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}));
      when(() => mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}Bloc.state).thenReturn(
      ...
      await widgetTester.pump{{#pascalCase}}{{name_plural}}{{/pascalCase}}List(mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}Bloc);
      expect(find.byType({{#pascalCase}}{{name_plural}}{{/pascalCase}}ListItem), findsNWidgets(4));
    });
  });

  group('{{#pascalCase}}{{name_plural}}{{/pascalCase}} list tests', () {
    testWidgets('render empty list', (widgetTester) async {
      // widgetTester.testRenderListEmpty(mock{{#pascalCase}}{{name_plural}}{{/pascalCase}}Bloc, [Loading(), const Loaded({{#snakeCase}}{{name_plural}}{{/snakeCase}}: []), Empty()], Empty(), {{#pascalCase}}{{name_plural}}{{/pascalCase}}SubscriptionRequestedEvent());
