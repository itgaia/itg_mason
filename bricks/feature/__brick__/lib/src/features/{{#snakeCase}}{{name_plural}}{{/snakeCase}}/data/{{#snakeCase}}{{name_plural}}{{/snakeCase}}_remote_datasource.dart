...
abstract class {{#pascalCase}}{{name_plural}}{{/pascalCase}}RemoteDataSource {
  ...
  Future<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model> create{{#pascalCase}}{{name_plural}}{{/pascalCase}}Item({{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {{#snakeCase}}{{name_plural}}{{/snakeCase}}Item);
  Future<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model> update{{#pascalCase}}{{name_plural}}{{/pascalCase}}Item({{#pascalCase}}{{name_plural}}{{/pascalCase}}Model {{#snakeCase}}{{name_plural}}{{/snakeCase}}Item);
...
class {{#pascalCase}}{{name_plural}}{{/pascalCase}}RemoteDataSourceImpl implements {{#pascalCase}}{{name_plural}}{{/pascalCase}}RemoteDataSource {
  ...
  Future<List<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model>> search{{#pascalCase}}{{name_plural}}{{/pascalCase}}(query) async {
    ...
    return List.generate(5, (i) => {{#pascalCase}}{{name_plural}}{{/pascalCase}}Model(description: 'description $i'));
  }
  ...
  Future<List<{{#pascalCase}}{{name_plural}}{{/pascalCase}}Model>> _get{{#pascalCase}}{{name_plural}}{{/pascalCase}}FromUrl(String url) async {
    ...
    try {
      final {{#snakeCase}}{{name_plural}}{{/snakeCase}}Url = Uri.parse(url);
      final response = await client.get(
        {{#snakeCase}}{{name_plural}}{{/snakeCase}}Url,
